...
import com.example.final_project.ui.viewmodel.Kategoriviewmodel.HomeUiState
...
fun HomeKScreen(
    ...
    Scaffold(
        ...
        HomeStatus(
            homeUiState = viewModel.katUiState,
            retryAction = { viewModel.getKat() },
            modifier = Modifier.padding(innerPadding),
            onDetailClick = onDetailClick, onDeleteClick = {
                viewModel.deleteKat(it.idkategori)
                viewModel.getKat()
            }
        )
    }
